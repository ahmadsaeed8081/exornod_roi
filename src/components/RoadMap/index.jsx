...
const RoadMap = () => {
  return (
    <div className=" tw-pb-16 tw-mx-auto container tw-text-white tw-relative">
      <h2 className="tw-text-center  tw-font-Dots tw-pb-10 tw-text-2xl sm:tw-text-3xl  tw-font-normal tw-mb-12">
        Road<span className="  tw-text-primary tw-font-Dots">map</span>
      </h2>
      ...
      <div className="tw-container tw-mx-auto tw-grid sm:tw-grid-cols-4 tw-grid-cols-1 tw-gap-6 tw-relative tw-z-10">
        {phases.map((phase, index) => (
          <div
            key={index}
            className={`tw-relative sm:tw-h-96 tw-h-auto    tw-bg-lightBlue tw-rounded-lg tw-shadow-lg tw-p-6 tw-border   tw-border-primary ${
